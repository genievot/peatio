...
describe Jobs::Cron::Portfolio do
  ...
  context 'price_at' do
    ...
    it 'when there is no trades' do
      market = Market.find_by(base_unit: 'btc')
      expect do
  ...
  context 'process_withdraw' do
    ...
    context 'coin withdraw' do
      ...
      it do
        ...
        expect(result[5].to_f).to eq coin_withdraw.fee
    ...
    context 'fiat withdraw' do
      ...
      it do
        ...
        expect(result[4].to_f).to eq 0
        expect(result[5].to_f).to eq fiat_withdraw.fee
        expect(result[6].to_f).to eq 0
        expect(result[7].to_i).to eq liability2.id
  ...
  context 'process_order' do
    ...
    context 'buy order' do
      it do
        ...
        expect(res1[6].to_f).to eq ((trade.amount + total_fees).to_f * trade_eth.price).to_f.round(1)
    ...
    context 'sell order' do
      it do
        ...
        expect(res1[5].to_f).to eq total_fees
        expect(res1[6].to_f).to eq ((trade.total + total_fees) * trade_eth.price).to_f.round(1)
        expect(res1[7].to_i).to eq liability.id
        expect(res1[8].to_f).to eq 0
        expect(res1[9].to_f).to eq 0
    ...
    context 'reference type deposit' do
      ...
      context 'creates one portfolio' do
        ...
        it do
          ...
          expect(Portfolio.last.total_fees).to eq coin_deposit.fee
      ...
      context 'creates several portfolios' do
        ...
        it do
          ...
          expect(Portfolio.second.total_fees).to eq coin_deposit.fee
          ...
          expect(Portfolio.last.total_debit).to eq 0
          expect(Portfolio.last.total_debit_value).to eq 0
          expect(Portfolio.last.total_fees).to eq fiat_deposit.fee
      ...
      context 'calculation on existing portfolio' do
        ...
        let!(:portfolio) { create(:portfolio, currency_id: coin_deposit.currency_id,  portfolio_currency_id: trade_btceth.market.quote_unit, total_credit: 0.1, 
                                  total_fees: 0.01, total_credit_value: 0.3, member_id: coin_deposit.member_id, last_liability_id: 1)}
        ...
        it do
          ...
          expect(Portfolio.last.total_fees).to eq (coin_deposit.fee + portfolio.total_fees)
    ...
    context 'reference type trade' do
      context 'calculation on existing portfolio' do
        ...
        let!(:portfolio3) { create(:portfolio, portfolio_currency_id: trade_btceth.market.quote_unit, currency_id: 'usd',
                                    total_credit: 0.4, total_fees: 0.01, total_credit_value: 0.3, total_debit: 0.2,
        ...
        let!(:portfolio4) { create(:portfolio, portfolio_currency_id: trade_btceth.market.quote_unit, currency_id: 'btc',
                                    total_credit: 0.4, total_fees: 0.01, total_credit_value: 0.3,
        ...
        it do
          ...
          expect(Portfolio.all[0].total_fees).to eq portfolio1.total_fees
          ...
          expect(Portfolio.all[1].total_fees).to eq total_fees + + portfolio2.total_fees
          ...
          expect(Portfolio.all[1].total_credit_value).to eq ((trade.total + total_fees) * trade_btceth.price).to_f.round(1) + portfolio2.total_credit_value
          ...
          expect(Portfolio.all[2].total_fees).to eq portfolio3.total_fees
          ...
          expect(Portfolio.all[3].total_fees).to eq total_fees + portfolio4.total_fees
          expect(Portfolio.all[3].total_credit_value).to eq ((trade.amount + total_fees) * trade_btceth.price).to_f.round(1) + portfolio4.total_credit_value
      ...
      context 'creates portfolios while executing 1 trade' do
        ...
        it do
          ...
          expect(Portfolio.all[1].total_fees).to eq total_fees
          expect(Portfolio.all[1].total_credit_value).to eq ((trade.total + total_fees) * trade_btceth.price).to_f.round(1)
          expect(Portfolio.all[1].last_liability_id).to eq liability.id
          ...
          expect(Portfolio.all[2].total_fees).to eq 0
          ...
          expect(Portfolio.all[3].total_fees).to eq total_fees
          expect(Portfolio.all[3].total_credit_value).to eq ((trade.amount + total_fees) * trade_btceth.price).to_f.round(1)
          expect(Portfolio.all[3].last_liability_id).to eq liability.id
          ...
          expect(Portfolio.all[4].total_fees).to eq 0
