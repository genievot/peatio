  ...
  module V2
    module Account
      class Portfolio < Grape::API
        ...
        get '/portfolio' do
          query = 'SELECT portfolio_currency_id, currency_id, total_credit, total_debit, total_fees, total_credit_value, total_debit_value, ' \
                  'total_credit_value / (total_credit + total_fees) `avarage_buy_price`, total_debit_value / (total_debit + total_fees) `avarage_sell_price` ' \
